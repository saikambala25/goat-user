...
app.put('/api/orders/:id', authMiddleware, async (req, res) => {
  try {
    ...
    // NOTE: In a real-world scenario, you might want a separate admin role check for updating status.
...
// Start Server
app.listen(PORT, () => {
  // 💡 Changed from 'http://localhost:${PORT}' to be environment-agnostic
